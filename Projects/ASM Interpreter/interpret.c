...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < lineCount; i++)
    {
        ...
        if (n == 1)
        {
            ...
            // read and print //
            if ((strcmp(instruction, "read") == 0) || (strcmp(instruction, "print") == 0))
            {
                char reg[10];
            ...
            else if ((strcmp(instruction, "mov") == 0) || (strcmp(instruction, "add") == 0) || (strcmp(instruction, "sub") == 0) || (strcmp(instruction, "mul") == 0) || (strcmp(instruction, "div") == 0))
            {
                char reg1[10];
                char reg2[10];
            ...
            // je, jne, jg, jge, jl, and jle //
            else if ((strcmp(instruction, "je") == 0) || (strcmp(instruction, "jne") == 0) || (strcmp(instruction, "jg") == 0) || (strcmp(instruction, "jge") == 0) || (strcmp(instruction, "jl") == 0) || (strcmp(instruction, "jle") == 0))
            {
                int jump;
                char reg1[10];
                char reg2[10];
